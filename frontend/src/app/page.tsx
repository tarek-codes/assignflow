...
export default function HomePage() {
  ...
  const handlePortalRedirect = () => {
    ...
    if (typeof window !== "undefined" && user?.id) {
      ...
      if (savedView === "manage") targetRoute = ROUTES.MANAGE;
        ...
        <section className="w-full flex-1 flex items-center justify-center px-3 pt-28 pb-16 sm:px-0 sm:pt-24 sm:pb-20 relative z-10">
          ...
          <div className="mx-auto w-full max-w-4xl px-1 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center justify-center">
            ...
            <div className="mt-6 flex w-full max-w-xs flex-col items-stretch justify-center gap-3 sm:mt-7 sm:max-w-none sm:w-auto sm:flex-row sm:items-center sm:gap-3.5">
              ...
              <Link
                href="/register"
                className="inline-flex w-full sm:w-44 items-center justify-center gap-2 rounded-2xl border border-slate-300 dark:border-slate-700 bg-white/90 dark:bg-slate-900/90 text-slate-800 dark:text-slate-100 font-extrabold text-sm shadow-md hover:bg-slate-50 dark:hover:bg-slate-800 active:scale-95 px-6 py-3.5 transition-all hover:-translate-y-0.5 backdrop-blur-md"
              >
                <span>Register</span>
